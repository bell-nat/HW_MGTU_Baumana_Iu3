...
while (true)
{
    ...
    {
        1 => new HW_MGTU_Baumana_Iu3.AreaTriangle.Handler(),
        2 => new HW_MGTU_Baumana_Iu3.ArrayInversions.Handler(),
        3 => new HW_MGTU_Baumana_Iu3.CloseNumbers.Handler(),
        4 => new HW_MGTU_Baumana_Iu3.BinarySearch.Handler(),
        5 => new HW_MGTU_Baumana_Iu3.HashTable.Handler(),
        6 => new HW_MGTU_Baumana_Iu3.BaseTree.Handler(),
        7 => new HW_MGTU_Baumana_Iu3.RedTree.Handler(),
